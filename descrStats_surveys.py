...
def run_ASR(df, out_dir=None):
    ...
    if out_dir:
        ...
        d = {'ASQQ79Freitext': '98',
             'ASR100Freitext': '122',
             'ASR92Freitext': '121',
             'ASRIABASEQ[ASRIA]': '1.A',
             'ASRIBBASEQ[ASRIB]': '1.B.',
             'ASRICBASEQ[ASRIC]': '1.C',
             'ASRIDBASEQ[ASRID]': '1.D',
             'ASRII1': '2.A',
             'ASRII1[comment]': '2.B',
             'ASRII2': '2.C',
             'ASRII3BASEQ[ASRIIA]': '2.D',
             'ASRII3BASEQ[ASRIIBr]': '2.E',
             'ASRII3BASEQ[ASRIIC]': '2.F',
             'ASRII3BASEQ[ASRIID]': '2.G',
             'ASRII3BASEQ[ASRIIEr]': '2.H',
             'ASRII3BASEQ[ASRIIFr]': '2.I',
             'ASRII3BASEQ[ASRIIG]': '2.J',
             'ASRII3BASEQ[ASRIIHr]': '2.K',
             'ASRIIIABASEQ[ASRIIIA]': '3.A',
             'ASRIIIBBASEQ[ASRIIIB]': '3.B.',
             'ASRIIICBASEQ[ASRIIIC]': '3.C',
             'ASRIIIDBASEQ[ASRIIID]': '3.D',
             'ASRIIIEaBASEQ[ASRIIIE]': '3.E',
             'ASRIIIEbBASEQ[ASRIIIE1]': '3.F',
             'ASRIIIEbBASEQ[ASRIIIE2]': '3.G',
             'ASRIIIEbBASEQ[ASRIIIE3]': '3.H',
             'ASRIIIEbBASEQ[ASRIIIE4]': '3.I',
             'ASRIIIFBASEQ[ASRIIIF]': '3.J',
             'ASRIVaBASEQ[ASRIV]': '4.A',
             'ASRIVbBASEQ[ASRIVA]': '4.B',
             'ASRIVbBASEQ[ASRIVBr]': '4.C',
             'ASRIVbBASEQ[ASRIVC]': '4.D',
             'ASRIVbBASEQ[ASRIVDr]': '4.E',
             'ASRIVbBASEQ[ASRIVE]': '4.F',
             'ASRIVbBASEQ[ASRIVFr]': '4.G',
             'ASRIVbBASEQ[ASRIVGr]': '4.H',
             'ASRIVbBASEQ[ASRIVHr]': '4.I',
             'ASRIVbBASEQ[ASRIVIr]': '4.J',
             'ASRQ101BASEQ[ASRQ101]': '123',
             'ASRQ101BASEQ[ASRQ102]': '124',
             'ASRQ101BASEQ[ASRQ103]': '125',
             'ASRQ101BASEQ[ASRQ104]': '126',
             'ASRQ101BASEQ[ASRQ105]': '127',
             'ASRQ101BASEQ[ASRQ106]': '128',
             'ASRQ101BASEQ[ASRQ107]': '129',
             'ASRQ101BASEQ[ASRQ108]': '130',
             'ASRQ101BASEQ[ASRQ109]': '131',
             'ASRQ101BASEQ[ASRQ110]': '132',
             'ASRQ10BASEQ[ASRQ10]': '20',
             'ASRQ10BASEQ[ASRQ11]': '21',
             'ASRQ10BASEQ[ASRQ12]': '22',
             'ASRQ10BASEQ[ASRQ13]': '23',
             'ASRQ10BASEQ[ASRQ14]': '24',
             'ASRQ10BASEQ[ASRQ15]': '25',
             'ASRQ10BASEQ[ASRQ16]': '26',
             'ASRQ10BASEQ[ASRQ17]': '27',
             'ASRQ10BASEQ[ASRQ18]': '28',
             'ASRQ10BASEQ[ASRQ19]': '29',
             'ASRQ10BASEQ[ASRQ20]': '30',
             'ASRQ111BASEQ[ASRQ111]': '133',
             'ASRQ111BASEQ[ASRQ112]': '134',
             'ASRQ111BASEQ[ASRQ113]': '135',
             'ASRQ111BASEQ[ASRQ114]': '136',
             'ASRQ111BASEQ[ASRQ115]': '137',
             'ASRQ111BASEQ[ASRQ116]': '138',
             'ASRQ111BASEQ[ASRQ117]': '139',
             'ASRQ111BASEQ[ASRQ118]': '140',
             'ASRQ111BASEQ[ASRQ119]': '141',
             'ASRQ111BASEQ[ASRQ120]': '142',
             'ASRQ121BASEQ[ASRQ121]': '143',
             'ASRQ121BASEQ[ASRQ122]': '144',
             'ASRQ121BASEQ[ASRQ123]': '145',
             'ASRQ124': '146',
             'ASRQ125': '147',
             'ASRQ126': '148',
             'ASRQ1BASEQ[ASRQ1]': '9',
             ...
             'ASRQ1BASEQ[ASRQ5]': '13',
             'ASRQ1BASEQ[ASRQ6]': '14',
             'ASRQ21BASEQ[ASRQ21]': '31',
             'ASRQ21BASEQ[ASRQ22]': '32',
             'ASRQ21BASEQ[ASRQ23]': '33',
             'ASRQ21BASEQ[ASRQ24]': '34',
             'ASRQ21BASEQ[ASRQ25]': '35',
             'ASRQ21BASEQ[ASRQ26]': '36',
             'ASRQ21BASEQ[ASRQ27]': '37',
             'ASRQ21BASEQ[ASRQ28]': '38',
             'ASRQ21BASEQ[ASRQ29]': '39',
             'ASRQ29Freitext': '40',
             'ASRQ30BASEQ[ASRQ30]': '41',
             'ASRQ30BASEQ[ASRQ31]': '42',
             'ASRQ30BASEQ[ASRQ32]': '43',
             'ASRQ30BASEQ[ASRQ33]': '44',
             'ASRQ30BASEQ[ASRQ34]': '45',
             'ASRQ30BASEQ[ASRQ35]': '46',
             'ASRQ30BASEQ[ASRQ36]': '47',
             'ASRQ30BASEQ[ASRQ37]': '48',
             'ASRQ30BASEQ[ASRQ38]': '49',
             'ASRQ30BASEQ[ASRQ39]': '50',
             'ASRQ30BASEQ[ASRQ40]': '51',
             'ASRQ40Freitext': '52',
             'ASRQ41BASEQ[ASRQ41]': '53',
             'ASRQ41BASEQ[ASRQ42]': '54',
             'ASRQ41BASEQ[ASRQ43]': '55',
             'ASRQ41BASEQ[ASRQ44]': '56',
             'ASRQ41BASEQ[ASRQ45]': '57',
             'ASRQ41BASEQ[ASRQ46]': '58',
             'ASRQ41BASEQ[ASRQ47]': '59',
             'ASRQ41BASEQ[ASRQ48]': '60',
             'ASRQ41BASEQ[ASRQ49]': '61',
             'ASRQ41BASEQ[ASRQ50]': '62',
             'ASRQ46Freitext': '63',
             'ASRQ51BASEQ[ASRQ51]': '64',
             'ASRQ51BASEQ[ASRQ52]': '65',
             'ASRQ51BASEQ[ASRQ53]': '66',
             'ASRQ51BASEQ[ASRQ54]': '67',
             'ASRQ51BASEQ[ASRQ55]': '68',
             'ASRQ56BASEQ[ASRVIII561]': '69.A',
             'ASRQ56BASEQ[ASRVIII562]': '69.B',
             'ASRQ56BASEQ[ASRVIII563]': '69.C',
             'ASRQ56BASEQ[ASRVIII564]': '69.D',
             'ASRQ56BASEQ[ASRVIII565]': '69.E',
             'ASRQ56BASEQ[ASRVIII566]': '69.F',
             'ASRQ56BASEQ[ASRVIII567]': '69.G',
             'ASRQ56Freitext': '69.H',
             'ASRQ57BASEQ[ASRQ57]': '70',
             'ASRQ57BASEQ[ASRQ58]': '71',
             'ASRQ57BASEQ[ASRQ59]': '72',
             'ASRQ57BASEQ[ASRQ60]': '73',
             'ASRQ58Freitext': '74',
             'ASRQ61BASEQ[ASRQ61]': '75',
             'ASRQ61BASEQ[ASRQ62]': '76',
             'ASRQ61BASEQ[ASRQ63]': '77',
             'ASRQ61BASEQ[ASRQ64]': '78',
             'ASRQ61BASEQ[ASRQ65]': '79',
             'ASRQ61BASEQ[ASRQ66]': '80',
             'ASRQ61BASEQ[ASRQ67]': '81',
             'ASRQ61BASEQ[ASRQ68]': '82',
             'ASRQ61BASEQ[ASRQ69]': '83',
             'ASRQ61BASEQ[ASRQ70]': '84',
             'ASRQ66': '85',
             'ASRQ6Freitext': '15',
             'ASRQ70': '86',
             'ASRQ71BASEQ[ASRQ71]': '87',
             'ASRQ71BASEQ[ASRQ72]': '88',
             'ASRQ71BASEQ[ASRQ73]': '89',
             'ASRQ71BASEQ[ASRQ74]': '90',
             'ASRQ71BASEQ[ASRQ75]': '91',
             'ASRQ71BASEQ[ASRQ76]': '92',
             'ASRQ71BASEQ[ASRQ77]': '93',
             'ASRQ71BASEQ[ASRQ78]': '94',
             'ASRQ71BASEQ[ASRQ79]': '95',
             'ASRQ71BASEQ[ASRQ80]': '96',
             'ASRQ77Freitext': '97',
             'ASRQ7BASEQ[ASRQ7]': '16',
             'ASRQ7BASEQ[ASRQ8]': '17',
             'ASRQ7BASEQ[ASRQ9]': '18',
             'ASRQ81BASEQ[ASRQ81]': '99',
             'ASRQ81BASEQ[ASRQ82]': '100',
             'ASRQ81BASEQ[ASRQ83]': '101',
             'ASRQ81BASEQ[ASRQ84]': '102',
             'ASRQ81BASEQ[ASRQ85]': '103',
             'ASRQ81BASEQ[ASRQ86]': '104',
             'ASRQ81BASEQ[ASRQ87]': '105',
             'ASRQ81BASEQ[ASRQ88]': '106',
             'ASRQ81BASEQ[ASRQ89]': '107',
             'ASRQ81BASEQ[ASRQ90]': '108',
             'ASRQ84Freitext': '109',
             'ASRQ85Freitext': '110',
             'ASRQ91BASEQ[ASRQ100]': '120',
             'ASRQ91BASEQ[ASRQ91]': '111',
             'ASRQ91BASEQ[ASRQ92]': '112',
             'ASRQ91BASEQ[ASRQ93]': '113',
             'ASRQ91BASEQ[ASRQ94]': '114',
             'ASRQ91BASEQ[ASRQ95]': '115',
             'ASRQ91BASEQ[ASRQ96]': '116',
             'ASRQ91BASEQ[ASRQ97]': '117',
             'ASRQ91BASEQ[ASRQ98]': '118',
             'ASRQ91BASEQ[ASRQ99]': '119',
             'ASRQ9Freitext': '19',
             'ASRVI': '6.A',
             'ASRVII': '7.A',
             'ASRVIII': '8.A',
             ...
             'ASRVa': '5.A',
             'ASRVa[comment]': '5.B',
             'ASRVbBASEQ[ASRV1]': '5.C',
             'ASRVbBASEQ[ASRV1comment]': '5.D',
             'ASRVbBASEQ[ASRV3]': '5.E',
             'ASRVbBASEQ[ASRV3comment]': '5.F',
             'ASRVbBASEQ[ASRV4]': '5.G',
             'ASRVbBASEQ[ASRV4comment]': '5.H',
             'ASRVcBASEQ[ASRVA]': '5.I',
             'ASRVcBASEQ[ASRVB]': '5.J',
